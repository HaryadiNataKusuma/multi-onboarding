...
export default {
  ...
  methods: {
    async loadInsurances() {
      try {
        console.log('🔄 Loading insurances from http://localhost:8080/api/property/insurances...')
        // Using Property program backend
        const response = await fetch('http://localhost:8080/api/property/insurances')
